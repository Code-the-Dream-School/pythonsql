...
def upgrade() -> None:
    ...
    sa.Column('CategoryID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
    sa.Column('CategoryName', sa.String(), nullable=True),
    sa.Column('Description', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('CategoryID')
    )
    op.create_table('employees',
    sa.Column('EmployeeID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
    ...
    sa.Column('ShipperID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
    sa.Column('ShipperName', sa.String(), nullable=True),
    sa.Column('Phone', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('ShipperID')
    )
    op.create_table('suppliers',
    sa.Column('SupplierID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
    ...
    sa.Column('OrderID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
    ...
    sa.Column('ProductID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
    ...
    sa.Column('OrderDetailID', sa.Integer(), nullable=False, primary_key=True, autoincrement=True),
