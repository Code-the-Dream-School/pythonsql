...
Customers and Orders.  A customer will
...
have the name CustomerID.  (This often not the case -- the column names may be different.)
You can find out how many orders each customer has with the following query:
